...
import { PostProcessManager } from './game-post-process'
...
export class GameRenderer {
  ...
  private readonly postProcess: PostProcessManager
  ...
  constructor(host: RendererHost) {
    this.host = host
    this.postProcess = new PostProcessManager(host)
  }
