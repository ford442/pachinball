/**
 * LCD Table Materials - the emissive phosphor-display playfield surface used
...
export class LCDTableMaterials extends PlayfieldMaterials {
  ...
  private createLCDGridTexture(): DynamicTexture {
    const size = Math.min(LCDTableMaterials.LCD_TEXTURE_SIZE, this.textureSize * 2)
  ...
  private drawLCDBackdrop(
    ctx: NonNullable<ReturnType<typeof LCDTableMaterials.getLCDContextType>>,
    size: number,
