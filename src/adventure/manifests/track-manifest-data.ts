...
export const MANIFEST_DATA: TrackManifest[] = [
  ...
  {
    id: AdventureTrackType.STORM_LATTICE,
    startAnchor: { x: 0, y: 30, z: 0 },
    buildKind: 'json',
    dataPath: './track-data/STORM_LATTICE.json',
    zone: {
      name: 'Storm Lattice',
      storyText: 'ENTERING: STORM LATTICE\n\nUpdrafts howl through the pin grid...',
      musicTrackId: 'storm-lattice',
      primaryColor: '#44ccff',
      accentColor: '#ffffff',
    ...
    catalog: {
      description: 'A storm-lashed pachinko board — updraft shafts loft the ball back into the pins before crosswinds herd it home.',
      difficulty: 'hard',
      modeType: 'STATIONARY_TABLE',
      ...
      theme: 'storm',
      visualTheme: { primary: 'CYAN', accent: 'WHITE', surfaceTint: 'PLAYFIELD_DEEP' },
    },
  },
  {
