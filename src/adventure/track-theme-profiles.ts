...
import { PALETTE, SURFACES } from '../game-elements/visual-language'
...
const CATALOG_PROFILES: Record<string, TrackThemeProfile> = {
  ...
  STORM_LATTICE: {
    trackId: 'STORM_LATTICE',
    label: 'Storm Lattice',
    palette: { primary: 'CYAN', accent: 'WHITE', surfaceTint: 'PLAYFIELD_DEEP' },
    materials: { structure: '#1a4a6e', accent: '#e8f6ff', energy: '#44ccff', glow: '#88ddff' },
    cabinet: { primary: '#44ccff', accent: '#e8f6ff' },
    atmosphere: {
      fogDensity: 0.013,
      fogColor: '#06121c',
    ...
    particles: { hitPrimary: '#44ccff', hitAccent: '#e8f6ff', ambient: 'electric-arc' },
  },
  PACHINKO_HALL: {
