...
describe('GameSlotAdventure.switchToTrack', () => {
  it('orchestrates teardown, build, cinematic, and UI reset in order', async () => {
    ...
    const host = {
      ...
      scoreElement: null,
      score: 42_000,
      adventureCinematicTriggers: { onTrackStart } as unknown as import('../src/adventure/adventure-cinematic-triggers').AdventureCinematicTriggers,
      adventureUIStateManager: { reset: uiReset } as unknown as import('../src/adventure/adventure-ui-state').AdventureUIStateManager,
      adventureGoalTracker: { initializeTrack: goalInit } as unknown as import('../src/adventure/adventure-goal-tracker').AdventureGoalTracker,
      adventureProgressionSupervisor: { startTrack: supervisorStart } as unknown as import('../src/adventure/adventure-progression-supervisor').AdventureProgressionSupervisor,
