...
const KNOWN_WORKER_GAPS: Record<string, string> = {
  ...
  serializeSnapshot: 'in-process only (#431): a blob needs a request/reply the batch protocol lacks',
  restoreSnapshot: 'in-process only (#431): replay verification runs on the owner world',
}
